...
class Model(nn.Module):
    def __init__(self, vocab_size_w, vocab_size_t, embedding_dim, hidden_dim, dropout_rate, pad_id):
        ...
        # 1. Embedding Layer
        # Vocabulaire des mots -> Embedding des mots
        self.embedding = nn.Embedding(vocab_size_w, embedding_dim, padding_idx=pad_id)

        # 2. GRU Layer (bidirectionnelle)
        # La couche GRU prendra en entrée des embeddings de dimension 'embedding_dim' et renverra des vecteurs cachés de taille 'hidden_dim'.
        ...
        # 4. Linear Layer (pour la classification des étiquettes)
    ...
    def forward(self, x):
        ...
        # 2. Passage à travers la couche GRU
        ...
        # 3. Appliquer Dropout sur les sorties du GRU pour la régularisation
        gru_out = self.dropout(gru_out)

        # 4. Passer les sorties du GRU à la couche linéaire pour obtenir les scores pour chaque étiquette
